...
if response is c, the message Sorry, no help is currently available is printed for
any other value of response, the message "Invalid entry, please try again!" is printed
...
input: a -Display prompt: "Your request is being processed"
         */
        String input;char command;
        Scanner scan=new Scanner(System.in);
        System.out.println("enter command 'a or b or c'");
        input=scan.nextLine();
